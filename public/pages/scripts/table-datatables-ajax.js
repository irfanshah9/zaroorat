var TableDatatablesAjax = function() {
    ...
    var handleAcMechanicRecords = function() {
     ...
     var handleCarMechanicRecords = function() {
        var grid = new Datatable();

        grid.init({
            src: $("#car_mechanic_table"),
            onSuccess: function(grid, response) {
                // grid:        grid object
                // response:    json object of server side ajax response
                // execute some code after table records loaded
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": "../get_car_mechanic_data", // ajax source
                },
                "order": [
                    [4, "desc"]
                ], // set first column as a default sort by asc
     ...
     var handleBikeMechanicRecords = function() {
        var grid = new Datatable();

        grid.init({
            src: $("#bike_mechanic_table"),
            onSuccess: function(grid, response) {
                // grid:        grid object
                // response:    json object of server side ajax response
                // execute some code after table records loaded
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": "../get_bike_mechanic_data", // ajax source
                },
                "order": [
                    [4, "desc"]
                ], // set first column as a default sort by asc
     ...
     var handleGasMechanicRecords = function() {
        var grid = new Datatable();

        grid.init({
            src: $("#gas_mechanic_table"),
            onSuccess: function(grid, response) {
                // grid:        grid object
                // response:    json object of server side ajax response
                // execute some code after table records loaded
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": "../get_gas_mechanic_data", // ajax source
                },
                "order": [
                    [4, "desc"]
                ], // set first column as a default sort by asc
    ...
    var handleLockMasterRecords = function() {
        var grid = new Datatable();

        grid.init({
            src: $("#lock_master_table"),
            onSuccess: function(grid, response) {
                // grid:        grid object
                // response:    json object of server side ajax response
                // execute some code after table records loaded
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": "../get_lock_master_data", // ajax source
                },
                "order": [
                    [4, "desc"]
                ], // set first column as a default sort by asc
    ...
    return {
        ...
        init: function() {
            ...
            handleCarMechanicRecords();
            handleBikeMechanicRecords();
            handleGasMechanicRecords();
            handleLockMasterRecords();
        }
};
}();
