                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">painter Management</span>
                        </div>
                        <div class="actions">
                            <a class="btn btn-sm green table-group-action-submit" href="{{url('admin/painter/create')}}"> Add New Painter</a>
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            <table class="table table-striped table-bordered table-hover table-checkable" id="painter_table">
                                <thead>
...
<script>
    $(document).ready(function() {
        $('#painter_table').find('.group-checkable2').change(function() {
        ...
        $('#painter_table').on('click', 'tr .checkboxes2', function() {
    ...
    $('#painter_table').keypress(function(e) {
    ...
    $(document).on('click', '.btnMultiDelete', function() {
        bootbox.confirm("<h4>Confirmation!</h4>Are you sure to delete selected Painters?", function(result) {
            if (result == true) {
