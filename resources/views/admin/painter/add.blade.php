    ...
    <div class="page-content">
         <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>@if(isset($edit)) Edit Painter @else Add New Painter @endif</span>
                </li>
            </ul>
        </div>
        @if(isset($edit))
        <form action="{{url('admin/painter/')}}/{{isset($painter) ? $painter->id : ''}}" id="painter_form" class="form-horizontal" method="post">
         {!! method_field('patch') !!}
        @else
         <form action="{{url('admin/painter')}}" id="plumber_form" class="form-horizontal" method="post">
         @endif
         {{ csrf_field() }}
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">@if(isset($edit)) Edit Painter @else Add New Painter @endif</span>
                    </div>
                </div>
              <div class="portlet-body">
                    <div class="form-body">
                        ...
                        <div class="form-group  margin-top-20">
                            <label class="control-label col-md-3">Painter Name
                                <span class="required"> * </span>
                            </label>
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="p_name" value="{{ isset($painter) ? $painter->p_name : old('p_name') }}" autocomplete="p_name" /> </div>
                        ...
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="p_f_name"  value="{{ isset($painter) ? $painter->p_f_name : old('p_f_name') }}" /> </div>
                            </div>
                        </div>
                         <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="p_phone_1" autocomplete="e_phone_1"  value="{{ isset($painter) ? $painter->p_phone_1 : old('p_phone_1') }}" /> </div>
                        ...
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="p_phone_2" autocomplete="p_phone_2" value="{{ isset($painter) ? $painter->p_phone_2 : old('p_phone_2') }}" /> </div>
                             </div>
                        </div>
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="p_shop" autocomplete="p_shop" value="{{ isset($painter) ? $painter->p_shop : old('p_shop') }}" /> </div>
                             </div>
                        </div>
                             ...
                             <div class="locations_div">
                                <div class="form-group" id="location_group_1">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                        <i class="fa"></i>
                                        <input type="text" id="location" name="p_location" value="{{ isset($painter) ? $painter->p_location : old('p_location') }}" class="form-control E_location" placeholder="Enter a location" onFocus=""/>
                                        <input type="hidden" class="location_input" name="p_latitude" value="{{ isset($painter) ? $painter->p_latitude : old('p_latitude') }}" id="latitude_input" />
                                        <input type="hidden" class="location_input" name="p_longitude" value="{{ isset($painter) ? $painter->p_longitude : old('p_longitude') }}" id="longitude_input" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea name="p_description" class="form-control" rows="5" data-error-container="#editor_error">{{ isset($painter) ? $painter->p_description : old('p_description') }}</textarea>
