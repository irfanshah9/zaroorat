    ...
    <div class="page-content">
         <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="">Labour Management</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <span>@if(isset($edit)) Edit Labour @else Add New Labour @endif</span>
                </li>
            </ul>
        </div>
        @if(isset($edit))
        <form action="{{url('admin/labour/')}}/{{isset($labour) ? $labour->id : ''}}" id="painter_form" class="form-horizontal" method="post">
         {!! method_field('patch') !!}
        @else
         <form action="{{url('admin/labour')}}" id="plumber_form" class="form-horizontal" method="post">
         @endif
         {{ csrf_field() }}
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">@if(isset($edit)) Edit Labour @else Add New Labour @endif</span>
                    </div>
                </div>
              <div class="portlet-body">
                    <div class="form-body">
                        ...
                        <div class="form-group  margin-top-20">
                            <label class="control-label col-md-3">Labour Name
                                <span class="required"> * </span>
                            </label>
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="l_name" value="{{ isset($labour) ? $labour->l_name : old('l_name') }}" autocomplete="p_name" /> </div>
                        ...
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="l_f_name"  value="{{ isset($labour) ? $labour->l_f_name : old('l_f_name') }}" /> </div>
                            </div>
                        </div>
                         <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="l_phone_1" autocomplete="l_phone_1"  value="{{ isset($labour) ? $labour->l_phone_1 : old('l_phone_1') }}" /> </div>
                               @if ($errors->has('l_phone_1'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('l_phone_1') }}</strong>
                                </span>
                            @endif
                            </div>
                        </div>
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="l_phone_2" autocomplete="l_phone_2" value="{{ isset($labour) ? $labour->l_phone_2 : old('l_phone_2') }}" /> </div>
                             </div>
                        </div>
                             ...
                             <div class="locations_div">
                                <div class="form-group" id="location_group_1">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                        <i class="fa"></i>
                                        <input type="text" id="location" name="l_location" value="{{ isset($labour) ? $labour->l_location : old('l_location') }}" class="form-control E_location" placeholder="Enter a location" onFocus=""/>
                                        <input type="hidden" class="location_input" name="l_latitude" value="{{ isset($labour) ? $labour->l_latitude : old('l_latitude') }}" id="latitude_input" />
                                        <input type="hidden" class="location_input" name="l_longitude" value="{{ isset($labour) ? $labour->l_longitude : old('l_longitude') }}" id="longitude_input" />
                                        @if ($errors->has('l_location'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('l_location') }}</strong>
                                </span>
                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea name="l_address" class="form-control" rows="5" data-error-container="#editor_error">{{ isset($labour) ? $labour->l_address : old('l_address') }}</textarea>
                               @if ($errors->has('l_address'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('l_address') }}</strong>
                                </span>
                            @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea name="l_description" class="form-control" rows="5" data-error-container="#editor_error">{{ isset($labour) ? $labour->l_description : old('l_description') }}</textarea>
                               @if ($errors->has('l_description'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('l_description') }}</strong>
                                </span>
                            @endif
                                <div id="editor_error"> </div>
                            </div>
