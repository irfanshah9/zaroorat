                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Labour Management</span>
                        </div>
                        <div class="actions">
                            <a class="btn btn-sm green table-group-action-submit" href="{{url('admin/labour/create')}}"> Add New Labour</a>
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            <table class="table table-striped table-bordered table-hover table-checkable" id="labour_table">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="l_name"> </td>

                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="l_father"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="l_contact"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="l_location"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="l_address"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="l_description"> </td>
                                        <td>
...
<script>
    $(document).ready(function() {
        $('#labour_table').find('.group-checkable2').change(function() {
        ...
        $('#labour_table').on('click', 'tr .checkboxes2', function() {
    ...
    $('#labour_table').keypress(function(e) {
    ...
    $(document).on('click', '.btnMultiDelete', function() {
        bootbox.confirm("<h4>Confirmation!</h4>Are you sure to delete selected Labours?", function(result) {
            if (result == true) {
