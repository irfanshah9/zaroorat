                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Mason Management</span>
                        </div>
                        <div class="actions">
                            <a class="btn btn-sm green table-group-action-submit" href="{{url('admin/mason/create')}}"> Add New Mason</a>
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            <table class="table table-striped table-bordered table-hover table-checkable" id="mason_table">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="m_name"> </td>

                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="m_father"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="m_contact"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="m_location"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="m_address"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="m_description"> </td>
                                        <td>
...
<script>
    $(document).ready(function() {
        $('#mason_table').find('.group-checkable2').change(function() {
        ...
        $('#mason_table').on('click', 'tr .checkboxes2', function() {
    ...
    $('#mason_table').keypress(function(e) {
    ...
    $(document).on('click', '.btnMultiDelete', function() {
        bootbox.confirm("<h4>Confirmation!</h4>Are you sure to delete selected Masons?", function(result) {
            if (result == true) {
