                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Lock Master Management</span>
                        </div>
                        <div class="actions">
                            <a class="btn btn-sm green table-group-action-submit" href="{{url('admin/lock_master/create')}}"> Add New Lock Master</a>
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            <table class="table table-striped table-bordered table-hover table-checkable" id="lock_master_table">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="lm_name"> </td>

                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="lm_father"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="lm_contact"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="lm_shop"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="lm_location"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="lm_description"> </td>
                                        <td>
...
<script>
    $(document).ready(function() {
        $('#lock_master_table').find('.group-checkable2').change(function() {
        ...
        $('#lock_master_table').on('click', 'tr .checkboxes2', function() {
    ...
    $('#lock_master_table').keypress(function(e) {
    ...
    $(document).on('click', '.btnMultiDelete', function() {
        bootbox.confirm("<h4>Confirmation!</h4>Are you sure to delete selected Lock Masters?", function(result) {
            if (result == true) {
