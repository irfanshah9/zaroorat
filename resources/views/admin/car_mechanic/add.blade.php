    ...
    <div class="page-content">
         <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>@if(isset($edit)) Edit Car Mechanic @else Add New Car Mechanic @endif</span>
                </li>
            </ul>
        </div>
        @if(isset($edit))
        <form action="{{url('admin/car_mechanic/')}}/{{isset($car_mechanic) ? $car_mechanic->id : ''}}" id="car_mechanic_form" class="form-horizontal" method="post">
         {!! method_field('patch') !!}
        @else
         <form action="{{url('admin/car_mechanic')}}" id="car_mechanic_form" class="form-horizontal" method="post">
         @endif
         {{ csrf_field() }}
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">@if(isset($edit)) Edit Car Mechanic @else Add New Car Mechanic @endif</span>
                    </div>
                </div>
              <div class="portlet-body">
                    <div class="form-body">
                        ...
                        <div class="form-group  margin-top-20">
                            <label class="control-label col-md-3">Car Mechanic Name
                                <span class="required"> * </span>
                            </label>
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="car_m_name" value="{{ isset($car_mechanic) ? $car_mechanic->car_m_name : old('car_m_name') }}" autocomplete="car_m_name" /> </div>
                               @if ($errors->has('car_m_name'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('car_m_name') }}</strong>
                                </span>
                            @endif
                            </div>
                        </div>
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="car_m_f_name"  value="{{ isset($car_mechanic) ? $car_mechanic->car_m_f_name : old('car_m_f_name') }}" /> </div>
                            </div>
                        </div>
                         <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="car_m_phone_1" autocomplete="e_phone_1"  value="{{ isset($car_mechanic) ? $car_mechanic->car_m_phone_1 : old('car_m_phone_1') }}" /> </div>
                               @if ($errors->has('car_m_phone_1'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('car_m_phone_1') }}</strong>
                                </span>
                            @endif
                            </div>
                        </div>
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="car_m_phone_2" autocomplete="car_m_phone_2" value="{{ isset($car_mechanic) ? $car_mechanic->car_m_phone_2 : old('car_m_phone_2') }}" /> </div>
                             </div>
                        </div>
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="car_m_shop" autocomplete="car_m_shop" value="{{ isset($car_mechanic) ? $car_mechanic->car_m_shop : old('car_m_shop') }}" /> </div>
                             </div>
                        </div>
                        <div id="location_container">
                             <div class="locations_div">
                                <div class="form-group" id="location_groucar_m_1">
                                    <label class="control-label col-md-3">Location
                                        <span class="required"> * </span></label>
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                        <i class="fa"></i>
                                        <input type="text" id="location" name="car_m_location" value="{{ isset($car_mechanic) ? $car_mechanic->car_m_location : old('car_m_location') }}" class="form-control E_location" placeholder="Enter a location" onFocus=""/>
                                        <input type="hidden" class="location_input" name="car_m_latitude" value="{{ isset($car_mechanic) ? $car_mechanic->car_m_latitude : old('car_m_latitude') }}" id="latitude_input" />
                                        <input type="hidden" class="location_input" name="car_m_longitude" value="{{ isset($car_mechanic) ? $car_mechanic->car_m_longitude : old('car_m_longitude') }}" id="longitude_input" />
                                        @if ($errors->has('car_m_location'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('car_m_location') }}</strong>
                                </span>
                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea name="car_m_description" class="form-control" rows="5" data-error-container="#editor_error">{{ isset($car_mechanic) ? $car_mechanic->car_m_description : old('car_m_description') }}</textarea>
                               @if ($errors->has('car_m_description'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('car_m_description') }}</strong>
                                </span>
                            @endif
