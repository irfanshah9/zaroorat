    ...
    <div class="page-content">
         <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>@if(isset($edit)) Edit Car Painter @else Add New Car Painter @endif</span>
                </li>
            </ul>
        </div>
        @if(isset($edit))
        <form action="{{url('admin/carpainter/')}}/{{isset($carpainter) ? $carpainter->id : ''}}" id="painter_form" class="form-horizontal" method="post">
         {!! method_field('patch') !!}
        @else
         <form action="{{url('admin/carpainter')}}" id="plumber_form" class="form-horizontal" method="post">
         @endif
         {{ csrf_field() }}
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">@if(isset($edit)) Edit Car Painter @else Add New Car Painter @endif</span>
                    </div>
                </div>
              <div class="portlet-body">
                    <div class="form-body">
                        ...
                        <div class="form-group  margin-top-20">
                            <label class="control-label col-md-3">Car Painter Name
                                <span class="required"> * </span>
                            </label>
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="cp_name" value="{{ isset($carpainter) ? $carpainter->cp_name : old('cp_name') }}" autocomplete="cp_name" /> </div>
                               @if ($errors->has('cp_name'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('cp_name') }}</strong>
                                </span>
                            @endif
                            </div>
                        </div>
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="cp_f_name"  value="{{ isset($carpainter) ? $carpainter->cp_f_name : old('cp_f_name') }}" /> </div>
                            </div>
                        </div>
                         <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="cp_phone_1"  value="{{ isset($carpainter) ? $carpainter->cp_phone_1 : old('cp_phone_1') }}" /> </div>
                               @if ($errors->has('cp_phone_1'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('cp_phone_1') }}</strong>
                                </span>
                            @endif
                            </div>
                        </div>
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="cp_phone_2" autocomplete="cp_phone_2" value="{{ isset($carpainter) ? $carpainter->p_phone_2 : old('cp_phone_2') }}" /> </div>
                             </div>
                        </div>
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="cp_shop" autocomplete="cp_shop" value="{{ isset($carpainter) ? $carpainter->cp_shop : old('cp_shop') }}" /> </div>
                             </div>
                        </div>
                             ...
                             <div class="locations_div">
                                <div class="form-group" id="location_group_1">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                        <i class="fa"></i>
                                        <input type="text" id="location" name="cp_location" value="{{ isset($carpainter) ? $carpainter->cp_location : old('cp_location') }}" class="form-control E_location" placeholder="Enter a location" onFocus=""/>
                                        <input type="hidden" class="location_input" name="cp_latitude" value="{{ isset($carpainter) ? $carpainter->cp_latitude : old('cp_latitude') }}" id="latitude_input" />
                                        <input type="hidden" class="location_input" name="cp_longitude" value="{{ isset($carpainter) ? $carpainter->cp_longitude : old('cp_longitude') }}" id="longitude_input" />
                                        @if ($errors->has('cp_location'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('cp_location') }}</strong>
                                </span>
                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea name="cp_description" class="form-control" rows="5" data-error-container="#editor_error">{{ isset($carpainter) ? $carpainter->cp_description : old('cp_description') }}</textarea>
                               @if ($errors->has('cp_description'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('cp_description') }}</strong>
                                </span>
                            @endif
