                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">AC Mechanic Management</span>
                        </div>
                        <div class="actions">
                            <a class="btn btn-sm green table-group-action-submit" href="{{url('admin/ac_mechanic/create')}}"> Add New AC Mechanic</a>
                    ...
                    <div class="portlet-body">
                        <div class="table-container">
                            <table class="table table-striped table-bordered table-hover table-checkable" id="ac_mechanic_table">
                                <thead>
                                    ...
                                    <tr role="row" class="filter">
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-filter input-sm" name="ac_m_name"> </td>

                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="ac_m_father"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="ac_m_contact"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="ac_m_shop"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="ac_m_location"> </td>
                                        <td>
                                          <input type="text" class="form-control form-filter input-sm" name="ac_m_description"> </td>
                                        <td>
...
<script>
    $(document).ready(function() {
        $('#ac_mechanic_table').find('.group-checkable2').change(function() {
        ...
        $('#ac_mechanic_table').on('click', 'tr .checkboxes2', function() {
    ...
    $('#ac_mechanic_table').keypress(function(e) {
    ...
    $(document).on('click', '.btnMultiDelete', function() {
        bootbox.confirm("<h4>Confirmation!</h4>Are you sure to delete selected AC Mechanics?", function(result) {
            if (result == true) {
