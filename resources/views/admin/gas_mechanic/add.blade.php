    ...
    <div class="page-content">
         <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>@if(isset($edit)) Edit Gas Mechanic @else Add New Gas Mechanic @endif</span>
                </li>
            </ul>
        </div>
        @if(isset($edit))
        <form action="{{url('admin/gas_mechanic/')}}/{{isset($gas_mechanic) ? $gas_mechanic->id : ''}}" id="gas_mechanic_form" class="form-horizontal" method="post">
         {!! method_field('patch') !!}
        @else
         <form action="{{url('admin/gas_mechanic')}}" id="gas_mechanic_form" class="form-horizontal" method="post">
         @endif
         {{ csrf_field() }}
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-green bold uppercase">@if(isset($edit)) Edit Gas Mechanic @else Add New Gas Mechanic @endif</span>
                    </div>
                </div>
              <div class="portlet-body">
                    <div class="form-body">
                        ...
                        <div class="form-group  margin-top-20">
                            <label class="control-label col-md-3">Gas Mechanic Name
                                <span class="required"> * </span>
                            </label>
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="gas_m_name" value="{{ isset($gas_mechanic) ? $gas_mechanic->gas_m_name : old('gas_m_name') }}" autocomplete="gas_m_name" /> </div>
                               @if ($errors->has('gas_m_name'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('gas_m_name') }}</strong>
                                </span>
                            @endif
                            </div>
                        </div>
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="gas_m_f_name"  value="{{ isset($gas_mechanic) ? $gas_mechanic->gas_m_f_name : old('gas_m_f_name') }}" /> </div>
                            </div>
                        </div>
                         <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="gas_m_phone_1" autocomplete="e_phone_1"  value="{{ isset($gas_mechanic) ? $gas_mechanic->gas_m_phone_1 : old('gas_m_phone_1') }}" /> </div>
                               @if ($errors->has('gas_m_phone_1'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('gas_m_phone_1') }}</strong>
                                </span>
                            @endif
                            </div>
                        </div>
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="gas_m_phone_2" autocomplete="gas_m_phone_2" value="{{ isset($gas_mechanic) ? $gas_mechanic->gas_m_phone_2 : old('gas_m_phone_2') }}" /> </div>
                             </div>
                        </div>
                        <div class="form-group  margin-top-20">
                            ...
                            <div class="col-md-4">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" class="form-control" name="gas_m_shop" autocomplete="gas_m_shop" value="{{ isset($gas_mechanic) ? $gas_mechanic->gas_m_shop : old('gas_m_shop') }}" /> </div>
                             </div>
                        </div>
                        <div id="location_container">
                             <div class="locations_div">
                                <div class="form-group" id="location_grougas_m_1">
                                    <label class="control-label col-md-3">Location
                                        <span class="required"> * </span></label>
                                    <div class="col-md-4">
                                        <div class="input-icon right">
                                        <i class="fa"></i>
                                        <input type="text" id="location" name="gas_m_location" value="{{ isset($gas_mechanic) ? $gas_mechanic->gas_m_location : old('gas_m_location') }}" class="form-control E_location" placeholder="Enter a location" onFocus=""/>
                                        <input type="hidden" class="location_input" name="gas_m_latitude" value="{{ isset($gas_mechanic) ? $gas_mechanic->gas_m_latitude : old('gas_m_latitude') }}" id="latitude_input" />
                                        <input type="hidden" class="location_input" name="gas_m_longitude" value="{{ isset($gas_mechanic) ? $gas_mechanic->gas_m_longitude : old('gas_m_longitude') }}" id="longitude_input" />
                                        @if ($errors->has('gas_m_location'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('gas_m_location') }}</strong>
                                </span>
                            @endif
                                        </div>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <textarea name="gas_m_description" class="form-control" rows="5" data-error-container="#editor_error">{{ isset($gas_mechanic) ? $gas_mechanic->gas_m_description : old('gas_m_description') }}</textarea>
                               @if ($errors->has('gas_m_description'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('gas_m_description') }}</strong>
                                </span>
                            @endif
